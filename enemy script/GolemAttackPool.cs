...
public class GolemAttackPool : MonoBehaviour
{
    public static GolemAttackPool Pooling_Instance;

    private List<GameObject> Objects_Pool = new List<GameObject>();

    private int AmountOfPool = 10;

    [SerializeField] GameObject golemAttack;
    private void Awake()
    {
    ...
    void Start()
    {
        ...
        {
            GameObject Obj = Instantiate(golemAttack);
